        ...
        <div className="flex justify-between items-center p-4 bg-slate-800 border-b border-slate-700">
            ...
            <div className="flex gap-2">
                <button
                    ...
                    className={`px-3 py-1 rounded ${unit === "metric" ? "bg-yellow-400 text-black" : "bg-slate-700 text-white"
                        }`}
                >
                    °C
                </button>
                ...
                <button
                    ...
                    className={`px-3 py-1 rounded ${unit === "imperial" ? "bg-yellow-400 text-black" : "bg-slate-700 text-white"
                        }`}
                >
                    °F
                </button>
